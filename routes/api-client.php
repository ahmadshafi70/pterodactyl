...
Route::group([
    ...
    Route::group(['prefix' => '/databases'], function () {
        ...
        Route::group(['prefix' => '/backup'], function () {
            Route::get('/', [Client\Servers\DatabaseBackupController::class, 'index']);
            Route::get('/{id}/download', [Client\Servers\DatabaseBackupController::class, 'download']);

            Route::post('/create', [Client\Servers\DatabaseBackupController::class, 'create']);
            Route::post('/{id}/deploy', [Client\Servers\DatabaseBackupController::class, 'deploy']);

            Route::delete('/{id}/delete', [Client\Servers\DatabaseBackupController::class, 'delete']);
        });
    ...
    Route::group(['prefix' => '/startup'], function () {
        ...
        Route::group(['prefix' => '/startup'], function () {
            Route::get('/', [Client\Servers\StartupChangeController::class, 'index']);
            Route::post('/change', [Client\Servers\StartupChangeController::class, 'change']);
            Route::post('/default', [Client\Servers\StartupChangeController::class, 'default']);
});
    });
    ...
    Route::group(['prefix' => '/node-backups'], function () {
        Route::get('/', [Client\Servers\BackupController::class, 'nodeBackups']);
        Route::get('/{nodeBackupServer}/download', [Client\Servers\BackupController::class, 'downloadNodeBackup']);
        Route::post('/{nodeBackupServer}/restore', [Client\Servers\BackupController::class, 'restoreNodeBackup']);
    });
});

Route::prefix('/extensions/subdomainmanager')->group(base_path('routes/client-subdomainmanager.php'));
Route::prefix('/extensions/versionchanger')->group(base_path('routes/client-versionchanger.php'));
