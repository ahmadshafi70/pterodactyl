...
import { UserIcon, EyeIcon, ViewGridIcon, TerminalIcon, FolderOpenIcon, DatabaseIcon, CalendarIcon, UserGroupIcon, ArchiveIcon, GlobeIcon, AdjustmentsIcon, CogIcon, CubeTransparentIcon, ArrowCircleDownIcon, GlobeAltIcon, CubeIcon } from '@heroicons/react/outline'
    ...
    server: {
        ...
        management: [
            ...
            },
            {
                ...
                component: SubdomainManagerContainer,
            },
            {
                path: '/modpacks',
                permission: 'file.*',
