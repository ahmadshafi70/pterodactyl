                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-xs-6">
                                    <label for="database_backup_limit" class="control-label">Database Backup Limit</label>
                                    <div>
                                        <input type="text" name="database_backup_limit" class="form-control" value="{{ old('database_backup_limit', $server->database_backup_limit) }}"/>
                                    </div>
                                    <p class="text-muted small">The total number of subservers that can be create for this server.</p>
                                </div>
                            </div>
                        </div>
                    </div>
