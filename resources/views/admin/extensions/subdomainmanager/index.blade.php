...
<?php 
    ...
    $EXTENSION_NAME = "Subdomain Manager";
    $EXTENSION_VERSION = "1.0.2";
    $EXTENSION_DESCRIPTION = "Allow creating Subdomains in the Dashboard using predefined domains easily with an intuitive UI.";
    $EXTENSION_ICON = "/assets/extensions/subdomainmanager/subdomainmanager_icon.jpg";
?>
