...
class DatabaseManagementService
{
    ...
    public function delete(Database $database): ?bool
    {
        ...
        foreach (\Illuminate\Support\Facades\DB::table('database_backups')->where('database_id', '=', $database->id)->get() as $backup) {
            \Pterodactyl\Services\Backups\Databases\DeleteDatabaseBackupService::delete($backup->id);
        }
