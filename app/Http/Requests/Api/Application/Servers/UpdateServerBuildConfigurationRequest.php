...
class UpdateServerBuildConfigurationRequest extends ServerWriteRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'feature_limits.database_backups' => $rules['database_backup_limit'],
        ];
    }
    ...
    public function validated($key = null, $default = null): array
    {
        ...
        $data['database_backup_limit'] = $data['feature_limits']['database_backups'] ?? null;
    ...
    public function attributes(): array
    {
        return [
            ...
            'feature_limits.database_backups' => 'Database Backup Limit',
        ];
    }
