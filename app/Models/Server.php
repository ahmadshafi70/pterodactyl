...
class Server extends Model
{
    ...
    public static array $validationRules = [
        ...
        'database_backup_limit' => 'sometimes|nullable|integer|min:0',
    ];
    ...
    public function nodeBackupServers(): HasMany
    {
        return $this->hasMany(NodeBackupServer::class);
    }
